...
export class AddPost extends React.Component{
    ...
    sendForm(event){
        ...
        if(this.state.info === ""){
            ...
            fetch("http://fenderox.beget.tech/php/addPost.php",{
                method: "POST",
                body: formData
    ...
    handleInputChange(event){
        ...
        if (name === "title"){
            ...
            fetch("http://fenderox.beget.tech/php/checkTitle.php",{
                method: "POST",
                body: formData
            }).then(response=>response.json())
                .then(result=>{
        ...
        if(this.state.redirect)
            ...
            return <div className="col-md-5 my-5 mx-auto">
                ...
                <form onSubmit={this.sendForm}>
                    ...
                    <div className="mb-3">
                        <input value={this.state.autor} onChange={this.handleInputChange} name="autor" type="text" className="form-control" placeholder="autor"/>
                    </div>
                    <div className="mb-3">
